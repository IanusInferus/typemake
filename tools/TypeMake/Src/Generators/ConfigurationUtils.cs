...
namespace TypeMake.Cpp
{
    public static class ConfigurationUtils
    {
        ...
        {
            var Matched = Configurations.StrictMatches(TargetType, HostOperatingSystem, HostArchitecture, TargetOperatingSystem, TargetArchitecture, Toolchain, Compiler, CLibrary, CLibraryForm, CppLibrary, CppLibraryForm, ConfigurationType).ToList();
